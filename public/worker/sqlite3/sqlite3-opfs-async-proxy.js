...
const installAsyncProxy = function (self) {
    ...
    else if (!((_a = navigator === null || navigator === void 0 ? void 0 : navigator.storage) === null || _a === void 0 ? void 0 : _a.getDirectory)) {
    ...
    */
    ...
    metrics.dump = () => {
        ...
        console.log((_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.location) === null || _a === void 0 ? void 0 : _a.href, 'metrics for', (_b = globalThis === null || globalThis === void 0 ? void 0 : globalThis.location) === null || _b === void 0 ? void 0 : _b.href, ':\n', metrics, '\nTotal of', n, 'op(s) for', t, 'ms', 'approx', w, 'ms spent waiting on OPFS APIs.');
    ...
    */
    const getDirForFilename = function f(absFilename, createDirs = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const dirName of path) {
                if (dirName) {
                    dh = yield dh.getDirectoryHandle(dirName, { create: !!createDirs });
                }
            }
            return [dh, filename];
        });
    ...
    */
    const closeSyncHandle = (fh) => __awaiter(this, void 0, void 0, function* () {
        if (fh.syncHandle) {
    ...
    /**
       ...
       removed.
    */
    const closeSyncHandleNoThrow = (fh) => __awaiter(this, void 0, void 0, function* () {
        try {
            yield closeSyncHandle(fh);
        }
        catch (e) {
    ...
    const releaseImplicitLocks = () => __awaiter(this, void 0, void 0, function* () {
        if (__implicitLocks.size) {
            /* Release all auto-locks. */
            for (const fid of __implicitLocks) {
                const fh = __openFiles[fid];
                yield closeSyncHandleNoThrow(fh);
    ...
    */
    const releaseImplicitLock = (fh) => __awaiter(this, void 0, void 0, function* () {
    ...
    */
    class GetSyncHandleError extends Error {
        constructor(errorObject, ...msg) {
            super([...msg, ': ' + errorObject.name + ':', errorObject.message].join(' '), {
                cause: errorObject,
            });
    ...
    /**
       ...
       an I/O error.
    */
    const getSyncHandle = (fh, opName) => __awaiter(this, void 0, void 0, function* () {
        if (!fh.syncHandle) {
            ...
            for (; true; ms = msBase * ++i) {
                try {
                    ...
                    fh.syncHandle = yield fh.fileHandle.createSyncAccessHandle();
                    break;
                }
                catch (e) {
                    if (i === maxTries) {
                        throw new GetSyncHandleError(e, 'Error getting sync handle for', opName + '().', maxTries, 'attempts failed.', fh.filenameAbs);
                    }
    ...
    */
    const vfsAsyncImpls = {
        'opfs-async-metrics': () => __awaiter(this, void 0, void 0, function* () {
            mTimeStart('opfs-async-metrics');
            metrics.dump();
            storeAndNotify('opfs-async-metrics', 0);
            mTimeEnd();
        }),
        'opfs-async-shutdown': () => __awaiter(this, void 0, void 0, function* () {
            flagAsyncShutdown = true;
            storeAndNotify('opfs-async-shutdown', 0);
        }),
        mkdir: (dirname) => __awaiter(this, void 0, void 0, function* () {
            mTimeStart('mkdir');
            let rc = 0;
            wTimeStart('mkdir');
            try {
                yield getDirForFilename(dirname + '/filepart', true);
            }
            catch (e) {
        ...
        xAccess: (filename) => __awaiter(this, void 0, void 0, function* () {
            mTimeStart('xAccess');
            ...
            */
            ...
            wTimeStart('xAccess');
            try {
                const [dh, fn] = yield getDirForFilename(filename);
        ...
        xClose: function (fid /*sqlite3_file pointer*/) {
            return __awaiter(this, void 0, void 0, function* () {
                const opName = 'xClose';
                mTimeStart(opName);
                ...
                if (fh) {
                    ...
                    if (fh.deleteOnClose) {
                        try {
                            yield fh.dirHandle.removeEntry(fh.filenamePart);
                        }
                        catch (e) {
        ...
        xDelete: function (...args) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xDelete');
                const rc = yield vfsAsyncImpls.xDeleteNoWait(...args);
                storeAndNotify('xDelete', rc);
                mTimeEnd();
            });
        },
        xDeleteNoWait: function (filename, syncDir = 0, recursive = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                */
                ...
                try {
                    while (filename) {
                        const [hDir, filenamePart] = yield getDirForFilename(filename, false);
                        if (!filenamePart)
                            break;
        ...
        xFileSize: function (fid /*sqlite3_file pointer*/) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const sz = yield (yield getSyncHandle(fh, 'xFileSize')).getSize();
                ...
                yield releaseImplicitLock(fh);
                wTimeEnd();
                storeAndNotify('xFileSize', rc);
                mTimeEnd();
            });
        },
        xLock: function (fid /*sqlite3_file pointer*/, lockType /*SQLITE_LOCK_...*/) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xLock');
                const fh = __openFiles[fid];
                let rc = 0;
        ...
        xOpen: function (fid /*sqlite3_file pointer*/, filename, flags /*SQLITE_OPEN_...*/, opfsFlags /*OPFS_...*/) {
            return __awaiter(this, void 0, void 0, function* () {
                const opName = 'xOpen';
                mTimeStart(opName);
                ...
                try {
                    ...
                    try {
                        [hDir, filenamePart] = yield getDirForFilename(filename, !!create);
                    }
                    catch (e) {
                        state.s11n.storeException(1, e);
                    ...
                    const hFile = yield hDir.getFileHandle(filenamePart, { create });
                    wTimeEnd();
        ...
        xRead: function (fid /*sqlite3_file pointer*/, n, offset64) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xRead');
                let rc = 0, nRead;
                const fh = __openFiles[fid];
                try {
                    wTimeStart('xRead');
                    nRead = (yield getSyncHandle(fh, 'xRead')).read(fh.sabView.subarray(0, n), { at: Number(offset64) });
                    wTimeEnd();
                    if (nRead < n) {
        ...
        xSync: function (fid /*sqlite3_file pointer*/, flags /*ignored*/) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xSync');
                const fh = __openFiles[fid];
                let rc = 0;
        ...
        xTruncate: function (fid /*sqlite3_file pointer*/, size) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield (yield getSyncHandle(fh, 'xTruncate')).truncate(size);
                }
                catch (e) {
        ...
        xUnlock: function (fid /*sqlite3_file pointer*/, lockType /*SQLITE_LOCK_...*/) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xUnlock');
                let rc = 0;
                const fh = __openFiles[fid];
        ...
        xWrite: function (fid /*sqlite3_file pointer*/, n, offset64) {
            return __awaiter(this, void 0, void 0, function* () {
                mTimeStart('xWrite');
                let rc;
                const fh = __openFiles[fid];
                ...
                try {
                    ...
                    rc =
                        n ===
                            (yield getSyncHandle(fh, 'xWrite')).write(fh.sabView.subarray(0, n), {
                                at: Number(offset64),
                            })
                            ? 0
    ...
    const waitLoop = function f() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (!flagAsyncShutdown) {
                try {
                    if ('not-equal' !==
                        Atomics.wait(state.sabOPView, state.opIds.whichOp, 0, state.asyncIdleWaitTime)) {
                        ...
                        */
                        yield releaseImplicitLocks();
                        continue;
                    }
                    const opId = Atomics.load(state.sabOPView, state.opIds.whichOp);
                    Atomics.store(state.sabOPView, state.opIds.whichOp, 0);
                    const hnd = (_a = opHandlers[opId]) !== null && _a !== void 0 ? _a : toss('No waitLoop handler for whichOp #', opId);
                    const args = state.s11n.deserialize(true /* clear s11n to keep the caller from confusing this with
        ...
        globalThis.onmessage = function ({ data }) {
            ...
            switch (data.type) {
                case 'opfs-async-init': {
                    ...
                    for (const k in opt)
                        state[k] = opt[k];
                    state.verbose = (_a = opt.verbose) !== null && _a !== void 0 ? _a : 1;
...
if (!globalThis.SharedArrayBuffer) {
    wPost('opfs-unavailable', 'Missing SharedArrayBuffer API.', 'The server must emit the COOP/COEP response headers to enable that.');
}
else if (!globalThis.Atomics) {
    wPost('opfs-unavailable', 'Missing Atomics API.', 'The server must emit the COOP/COEP response headers to enable that.');
}
