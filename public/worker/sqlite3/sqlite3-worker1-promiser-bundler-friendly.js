...
globalThis.sqlite3Worker1Promiser = function callee(config = callee.defaultConfig) {
    ...
    const genMsgId = config.generateMessageId ||
        function (msg) {
    ...
    return function () {
        ...
        if (rowCallbackId)
            p = p.finally(() => delete handlerMap[rowCallbackId]);
        return p;
    };
};
globalThis.sqlite3Worker1Promiser.defaultConfig = {
    worker: function () {
        ...
        currentScript: (_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) === null || _a === void 0 ? void 0 : _a.currentScript,
    }),
